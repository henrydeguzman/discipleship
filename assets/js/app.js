 ...
 */
var victory=angular.module('app',['ui.bootstrap','ui.router','MainDirectives','MainControllers','MainFactories','MainValues','MainFilters','dialogs.main','ui-notification',"MainFormatters"]);
